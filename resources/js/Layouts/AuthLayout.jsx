    ...
    return (
        <div className="public-theme min-h-screen bg-brand-faint text-slate-900">
            <div className="min-h-screen lg:grid lg:grid-cols-[1.05fr_0.95fr]">
                <div className="relative hidden overflow-hidden bg-brand-gradient px-8 py-10 text-white lg:flex lg:flex-col lg:justify-between lg:rounded-r-[90px] lg:px-12 lg:py-14">
                    ...
                    <div className="relative z-10">
                        <Link href="/" className="flex items-center gap-3">
                            <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-white/90 text-brand-primary shadow-lg lg:h-11 lg:w-11 lg:rounded-2xl">
                    ...
                    <div className="relative z-10 mt-8 flex items-center gap-4 lg:mt-10 lg:gap-6">
                        <div className="relative">
                            ...
                            <div className="absolute -bottom-3 left-8 h-8 w-12 rounded-[12px] bg-brand-primary opacity-80 shadow-lg lg:-bottom-4 lg:left-10 lg:h-10 lg:w-16 lg:rounded-[14px]" />
                        </div>
